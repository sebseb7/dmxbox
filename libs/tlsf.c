...
/*
static void integrity_walker(void* ptr, size_t size, int used __attribute__((unused)), void* user)
{
...
static void default_walker(void* ptr __attribute__((unused)), size_t size __attribute__((unused)), int used __attribute__((unused)))
{
//	(void)user;
...
int tlsf_check_pool(pool_t pool __attribute__((unused)))
{
